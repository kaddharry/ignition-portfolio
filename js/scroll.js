...
try {
  ...
  // --- AUDIO CONTROL TRIGGER (Relocated below Horizontal Pin) ---
  // By calculating this POST-horizontal-pin, it guarantees that "endTrigger: #section-about"
  // factors in the massive ~300vw padding block generated by the horizontal array!
  ScrollTrigger.create({
    trigger: "#section-intro",
    start: "top+=48% top", // Physically aligns flush with Intro Text 2 entering
    endTrigger: "#section-about", 
    end: "top top", // Extinguishes perfectly as the final section meets top edge
    onEnter: () => {
